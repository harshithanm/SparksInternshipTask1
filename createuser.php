...
?>
        ...
        <h2 class="text-center py-2" style="color:white; background-color:#6c757f;">CREATE A USER</h2>
        <br>
    ...
    <div class="screen" style="background: #868b90;">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="bb.jpg" style="max-width: 100%; border: none; border-radius: 10%;">
        </div>
...
<footer class="text-center mt-5 py-2"style="background-color : lavender;">
            <p>&copy 2021 Made by <b>HARSHITHA N M</b></p>
</footer>
